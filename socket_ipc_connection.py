"""
  This module contains the SocketIPCConnection class and its subclasses.
"""
...
class SocketIPCConnection(object):
  ...
  """
  def __init__(self, opened_socket, message_object_class):
    """
      ...
      Args:
        ...
        message_object_class:
          The class of the message objects returned by getters
      Returns:
        returns nothing
    """
